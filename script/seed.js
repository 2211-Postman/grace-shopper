...
async function seed() {
  ...
  const products = await Promise.all([
    ...
    Product.create({
      ...
      stockCount: 3,
      imageURL: [
        "https://img.stadiumgoods.com/14/07/70/10/14077010_43040970_2048.jpg",
        "https://cdn.flightclub.com/2600/TEMPLATE/347629/1.jpg",
      ],
    }),
    Product.create({
      ...
      stockCount: 2,
      imageURL: [
        "https://img.stadiumgoods.com/12/95/99/12/12959912_42942730_2048.jpg",
        "https://cdn.flightclub.com/2600/TEMPLATE/347629/1.jpg",
      ],
    }),
    Product.create({
      ...
      stockCount: 2,
      imageURL: [
        "https://img.stadiumgoods.com/14/75/81/38/14758138_43099728_2048.jpg",
        "https://cdn.flightclub.com/2600/TEMPLATE/347629/1.jpg",
      ],
    }),
    Product.create({
      ...
      stockCount: 2,
      imageURL: [
        "https://img.stadiumgoods.com/16/24/68/57/16246857_43122629_2048.jpg",
        "https://cdn.flightclub.com/2600/TEMPLATE/347629/1.jpg",
      ],
    }),
    Product.create({
    ...
    Product.create({
      ...
      stockCount: 3,
      imageURL: [
        "https://img.stadiumgoods.com/16/16/89/84/16168984_43120224_2048.jpg",
        "https://cdn.flightclub.com/2600/TEMPLATE/347629/1.jpg",
      ],
    }),
    Product.create({
      ...
      stockCount: 2,
      imageURL: [
        "https://img.stadiumgoods.com/16/72/03/76/16720376_42940072_2048.jpg",
        "https://cdn.flightclub.com/2600/TEMPLATE/347629/1.jpg",
      ],
    }),
    Product.create({
      ...
      stockCount: 8,
      imageURL: [
        "https://img.stadiumgoods.com/17/04/98/10/17049810_43019328_2048.jpg",
        "https://cdn.flightclub.com/2600/TEMPLATE/347629/1.jpg",
      ],
    }),
    Product.create({
      ...
      stockCount: 1,
      imageURL: [
        "https://img.stadiumgoods.com/12/96/03/50/12960350_42960069_2048.jpg",
        "https://cdn.flightclub.com/2600/TEMPLATE/347629/1.jpg",
      ],
    }),
    Product.create({
      ...
      stockCount: 3,
      imageURL: [
        "https://img.stadiumgoods.com/12/43/12/89/12431289_27476285_2048.jpg",
        "https://cdn.flightclub.com/2600/TEMPLATE/347629/1.jpg",
      ],
    }),
    Product.create({
    ...
    Product.create({
      ...
      stockCount: 12,
      imageURL: [
        "https://img.stadiumgoods.com/12/42/77/02/12427702_42962548_2048.jpg",
        "https://cdn.flightclub.com/2600/TEMPLATE/347629/1.jpg",
      ],
    }),
  ]);
